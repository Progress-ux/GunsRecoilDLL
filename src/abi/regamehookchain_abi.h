...
namespace regame
{
    ...
    public:
        virtual t_ret callNext(
            t_class *pThis,
            t_args... args
        ) = 0;

        virtual t_ret callOriginal(
            t_class *pThis,
            t_args... args
        ) = 0;
    };
    ...
    {
    public:
        using hookfunc_t = t_ret (*)(
            IHookChainClass<t_ret, t_class, t_args...> *,
            t_class *,
            t_args...
        );
    ...
    using IReGameHookRegistry_CBaseEntity_FireBullets3 = 
